...
function andRestrictToSelf(req, res, next) {
    ...
    if (req.authenticatedUser.id === req.user.id) {
        ...
        // You may want to implement specific exceptions such as UnauthorizedError or similar so that you
...
// Middleware for faux authentication you would of course implement something real,
// but this illustrates how an authenticated user may interact with middleware
