...
mongoose.connect('mongodb://127.0.0.1:27017/vinyl-records', {
...
// Configuring Express app with the CORS and BodyParser libraries
app.use(cors());
...
app.delete('/api/vinyl-records/:id', (req, res) => {
    VinylRecord.findByIdAndRemove(req.params.id)
        .then((vinylRecord) => {
            ...
            res.status(404).json({message: 'Vinyl record deleted successfully'});
        })
        .catch(error => {
